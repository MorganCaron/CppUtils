		...
		[[nodiscard]] TestSettings& executeCommands(const int argc, const char *argv[])
		{
			...
			m_settings.abort = m_parametersLexer.executeCommands(argc, argv, {
				...
				},
				{
					"verbose",
					[this]([[maybe_unused]] auto value) -> bool {
						m_settings.verbose = (value.empty() or value == "1" or value == "true");
						return false;
					}
				},
				{
					"detail",
					[this]([[maybe_unused]] auto value) -> bool {
						m_settings.detail = (value.empty() or value == "1" or value == "true");
						return false;
					}
				},
				{
					"failFast",
					[this]([[maybe_unused]] auto value) -> bool {
						m_settings.failFast = (value.empty() or value == "1" or value == "true");
						return false;
					}
				},
				{
					"chrono",
					[this]([[maybe_unused]] auto value) -> bool {
						m_settings.chrono = (value.empty() or value == "1" or value == "true");
						return false;
					}
				},
				{

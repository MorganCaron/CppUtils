...
int main(const int argc, const char *argv[])
{
	try
	{
		const auto tests = CppUtils::Container::Vector::merge({
			...
			std::cref(CppUtils::UnitTests::Language::Ini::IniLexer::tests),
			std::cref(CppUtils::UnitTests::Language::Json::JsonLexer::tests),
			std::cref(CppUtils::UnitTests::Language::StringTree::StringTreeLexer::tests),

...
namespace CppUtils::UnitTests::Language::Lexer::JsonLexer
{
	const auto tests = std::vector<CppUtils::Test>{

		CppUtils::Test{"Language/Lexer/JsonLexer/minimalist", [] {
		...
		CppUtils::Test{"Language/Lexer/JsonLexer/object", [] {
			using namespace CppUtils::Type::Literals;
			using namespace CppUtils::Language::Lexer::Literals;
			const auto jsonTree = R"(
			{
		...
		CppUtils::Test{"Language/Lexer/JsonLexer/array", [] {
			using namespace CppUtils::Type::Literals;
			using namespace CppUtils::Language::Lexer::Literals;
			const auto jsonTree = R"(
			{
